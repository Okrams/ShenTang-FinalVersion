					...
					<tr>
						...
						<td> 
							...
							//if($_SESSION['Permisos']<=2){
								...
								?>
								<span href="#modal2p" onclick="obteberDatosPro(<?php echo $registro->IDP; ?>)" class="btn-small amber modal-trigger" style="margin-left: 1px;"><i class="material-icons ">edit</i></span>
