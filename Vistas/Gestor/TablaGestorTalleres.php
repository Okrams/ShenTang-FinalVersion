					...
					<tr>
						...
						<td>
							...
							//if($_SESSION['Permisos']<=2){
								...
								?>
								<span href="#modal2t" onclick="obteberDatosTa(<?php echo $registro->ID; ?>)" class="btn-small amber modal-trigger" style="margin-left: 1px;"><i class="material-icons ">edit</i></span>
								<span onclick="eliminarTaller(<?php echo $registro->ID; ?>)" class="btn-small red" style="margin-left: 1px;"><i class="material-icons ">delete</i></span>
								<?php
							//}
							?>
						</td>
